"""
Changing Logs:
1. add n_embed parameter to transformer to decide embedding number.
"""
...
class BidirectionalTransformer(nn.Module):
    def __init__(self, N=24, dim=768, n_embed=128, codebook_size=1024):
        super(BidirectionalTransformer, self).__init__()

        self.tok_emb = nn.Embedding(n_embed, dim)
...
#         print("token_embedded: ",token_embeddings.max())
...
#         print("token_predicted: ",tkn_prd.max())
        return tkn_prd
